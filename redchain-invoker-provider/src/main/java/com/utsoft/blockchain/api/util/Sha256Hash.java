...
public class Sha256Hash implements Serializable, Comparable<Sha256Hash> {
	...
	private static final long serialVersionUID = 7366544304606619485L;
    ...
    public static Sha256Hash wrap(String hexString) {
        return wrap(SdkUtil.HEX.decode(hexString));
    }
    ...
    public static Sha256Hash wrapReversed(byte[] rawHashBytes) {
        return wrap(SdkUtil.reverseBytes(rawHashBytes));
    }
    ...
    public String toString() {
        return SdkUtil.HEX.encode(bytes);
    }
    ...
    public byte[] getReversedBytes() {
        return SdkUtil.reverseBytes(bytes);
    }
